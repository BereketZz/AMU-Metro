...
function MiniFooter() {
    const{isDarkMode, setIsDarkMode,toggleTheme}= useContext(AuthContext) 
  return (
    <footer className={`${isDarkMode?"bg-primary-black":"bg-white"}`}>
    <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
        <div class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-3">
            <div>
                ...
                <ul className={`${isDarkMode?"text-gray-500 dark:text-gray-400":"text-gray-900"}`}>
                    <li class="mb-4">
                        <Link href="/#About" class=" hover:underline">About</Link>
                    </li>
                    <li class="mb-4">
                        <Link href="/Analysis" class="hover:underline">Insights</Link>
                    </li>
                 
                    <li class="mb-4">
                        <Link href="/Stations" class="hover:underline">Blog</Link>
                    </li>
                    <li class="mb-4">
            ...
            <div>
                ...
                <ul  className={`${isDarkMode?"text-gray-500 dark:text-gray-400":"text-gray-900"}`}>
                    <li class="mb-4">
                        <Link href="/research" class="hover:underline">Research</Link>
                    </li>
                    <li class="mb-4">
                        <Link href="/m-datas" class="hover:underline">Station Data</Link>
                    </li>
