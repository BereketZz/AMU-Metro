...
import Metro_Data from '../pages/Metro_Data';


function Arbaminch({isDarkMode, date}) {
    const options = { year: 'numeric', month: 'long', day: 'numeric' };
  return (
    <Metro_Data>
    <div className='w-full flex flex-col '>
        <h2 className={` mt-[50px] ${isDarkMode?"text-white":"text-gray-700"}  text-[20px] font-bold`}>Sample Data for Arbaminch Station</h2>  
