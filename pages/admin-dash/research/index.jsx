...
function index() {
 ...
 <div className="text-white flex justify-center items-center flex-col">
  ...
  <div class="mb-6">
    ...
    <input type="text"  id="name" name="name" onChange={handleChange} value={inp.name} class={isDarkMode? "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-green-700 outline-none":" border border-gray-900 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-900 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-green-700 outline-none" }placeholder="Kaleb Abera" required />
  </div>
  <div class="mb-6">
    <label for="year" class={`block mb-2 text-sm font-medium  ${isDarkMode?"dark:text-white":"text-gray-900"} `}>Publication Year</label>
    <input type="text" id="year" name="year" onChange={handleChange} value={inp.year} class={isDarkMode?"bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-green-700  outline-none":" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-900 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-greem-700 ouline-none" } placeholder='2012' required/>
  </div>
  <div class="mb-6">
